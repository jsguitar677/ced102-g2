...
session_start();
    try{
        ...
        //LOCATION LOCPIC;
        $sql = "select a.ACTNO, a.ACTLOC, a.ACTNAME, a.RECRGOAL, a.RECRNOW, a.DNTGOAL, a.DNTNOW, a.ACTDLINE, b.LOCPIC from ACTV a JOIN LOCATION b ON a.ACTLOC = b.LOCNAME order by a.ACTSDATE desc";
