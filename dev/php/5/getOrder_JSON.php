...
try{
  ...
  $sql = "select o.orderno ,o.orderdate, o.mbrno,o.orderstatus,o.paystat,o.shipstat, m.mbrname, o.CONSIG,o.CONSIGADD,o.CONSIGTEL,o.ordertoal,o.discount,o.propricttotal-discount as ordertoal  from orders o join mbr m on o. mbrno= m. mbrno order by orderno asc;";
