...
try{
  ...
  $sql = "select o.orderno ,o.orderdate, o.mbrno,o.orderstatus,o.paystat,o.shipstat, m.mbrname, o.CONSIG,o.CONSIGADD,o.CONSIGTEL,o.POSTCODE,o.ordertoal,o.discount,o.ordertoal-discount as propricttotal  from orders o join mbr m on o. mbrno= m. mbrno order by orderno asc;";
